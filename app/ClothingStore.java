...
public class ClothingStore extends Store{
    ...
    public ClothingStore(String name, int employeeCount, double employeeBaseSalary, Address storeAddress, Date foundationDate, int maximumProductCount, boolean importedProducts) {
